...
-- Uso de Encriptación  SHA2 + SALT:
-- (SHA-256): Transforma la contraseña en un hash único e irreversible de 64 caracteres.
-- SALT: Se utiliza el 'email' del usuario como Salt dinámico (único por registro).
-- Al fusionar la clave con el email antes del hash, se evitan contraseñas iguales.
-- Se requiere la extensión 'pgcrypto' activa en el DDL; 'digest()' genera el bloque binario y 'encode(..., "hex")' lo traduce a texto plano almacenable en el VARCHAR de la tabla.

-- Tabla Usuario
insert into usuario (id_tipo_documento, numero_documento, email, password, fecha_nacimiento, 
primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, numero_celular, tipo_sangre, nombre_acudiente, documento_acudiente) values
(1, '1233504140', 'andrejur055@gmail.com', 'encriptaraqui01', '1999-02-09', 'Jeison', 'Andrey', 'Sosa','Espitia', '3203720455', 'O+', NULL, NULL),
(2, '1023456789', 'laura.martinez@gmail.com', 'clave001', '2005-07-12', 'Laura', 'Sofía', 'Martínez', 'Gómez', '3114567890', 'A+', 'Alfonso Martínez', '798456345'),
(1, '798456123', 'carlos.ruiz@gmail.com', 'clave002', '1988-11-23', 'Carlos', 'Andrés', 'Ruiz', 'Pérez', '3001234567', 'B+', NULL, NULL),
(3, '456789123', 'maria.lopez@gmail.com', 'clave003', '1995-03-30', 'María', NULL, 'López', 'Ramírez', '3209876543', 'O-', NULL, NULL),
(1, '1547896320', 'juan.castro@gmail.com', 'clave004', '1992-09-15', 'Juan', 'David', 'Castro', NULL, '3102345678', 'AB+', NULL, NULL),
(2, '1122334455', 'sofia.torres@gmail.com', 'clave005', '2008-01-20', 'Sofía', 'Alejandra', 'Torres', 'Vargas', '3156789012', 'A-', 'Emiliana Vargas', '798567345'),
(1, '987654321', 'andres.moreno@gmail.com', 'clave006', '1985-06-10', 'Andrés', NULL, 'Moreno', 'Rojas', '3008765432', 'O+', NULL, NULL),
(3, '321654987', 'luis.garcia@gmail.com', 'clave007', '1990-12-05', 'Luis', 'Alberto', 'García', 'Jiménez', '3193456789', 'B-', NULL, NULL),
(1, '741852963', 'paula.restrepo@gmail.com', 'clave008', '1998-04-18', 'Paula', 'Andrea', 'Restrepo', 'Cano', '3125678901', 'AB-', NULL, NULL),
(2, '159357486', 'diego.herrera@gmail.com', 'clave009', '2006-08-27', 'Diego', NULL, 'Herrera', 'Ortiz', '3147890123', 'O+', 'Mario Herrera', '798789345'),
(1, '753951456', 'valentina.suarez@gmail.com', 'clave010', '2000-10-09', 'Valentina', 'Lucía', 'Suárez', 'Mendoza', '3168901234', 'A+', NULL, NULL);


-- Tabla Autorizacion_Usuario
insert into autorizacion_usuario (rol, id_usuario) values
...
-- Tabla Odontologo
insert into odontologo (id_usuario, estado_odontologo, fecha_registro, especializacion) values
(9, 'activo', '2026-04-13', 'Odontologia General'), 
(3, 'activo', '2026-04-13', 'Ortodoncia');


-- Tabla Paciente
insert into paciente (id_usuario, fecha_registro, estado_paciente) values
(2, '2026-04-14', 'activo'), (6, '2026-04-14', 'activo'), 
(1, '2026-04-14', 'activo'), (4, '2026-04-14', 'activo'), 
(7, '2026-04-14', 'activo'), (10, '2026-04-14', 'activo'),
(5, '2026-04-14', 'activo'), (8, '2026-04-14', 'activo'), 
...
(8, 8, 31, 'oclusal', 'Aplicación de sellante', 'finalizado', 60000.00),
