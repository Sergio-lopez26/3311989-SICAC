...
const RegistroMedico = () =>{
    ...
    return(
        ...
        <header className="text-center mt-3">
            ...
            <h5 style={{ color: "#103e6e", fontWeight: "bolder" }}>Para regitrar al médico, se debe crear primero su usuario</h5>
            <Link to='/Registro_Inicial' className="btn btn-link p-0 mb-1 fw-bold">Registrar usuario aquí</Link>
        ...
        <div className="container-fluid mt-4 px-4">
            <div className="row g-4 justify-content-center">
                ...
                <div className="col-12 col-lg-6" style={{ maxWidth: "550px", alignSelf: "flex-start"  }}>
                    ...
                    {mostrarForm ? (
                    <div id="wrapperForm" className="card shadow-sm border-0 p-4" style={{ borderRadius: "16px", backgroundColor: "#ffffff" }}>
                        ...
                        <div className="card shadow-sm border-0 p-4 text-center justify-content-center h-100" style={{ borderRadius: "16px", backgroundColor: "#f8f9fa", border: "2px dashed #c2dbfe", minHeight: "350px" }}>
