...
//Obtener el registro de médico a partir del id_usuario (útil para vincular la sesión logueada con su ficha de médico)
router.get('/usuario/:id_usuario', async (req, res) => {
    try {
        ...
        if (rows.length === 0) {
            return res.status(404).json({ error: 'No se encontró un médico asociado a este usuario' });
        }
