    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg bg-primary navbar-dark h-lg-60" style={{ minHeight: "60px" }}>
            <div className="container-fluid h-100">
                ...
                <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#plegablePaciente" aria-controls="plegablePaciente" aria-expanded="false" aria-label="Toggle navigation">
                    <span className="navbar-toggler-icon"></span>
                </button>

                <div className="collapse navbar-collapse text-center" id="plegablePaciente">
                    <ul className="navbar-nav me-lg-auto mb-3 mb-lg-0 w-100 w-lg-auto">
                        <li className="nav-item">
                            <Link to='/Menu_Paciente' className="nav-link">Inicio</Link>
                        </li>
                        <li className="nav-item">
                            <Link to='/Mis_Citas' className="nav-link">Mis Citas</Link>
                        </li>
                    </ul>
