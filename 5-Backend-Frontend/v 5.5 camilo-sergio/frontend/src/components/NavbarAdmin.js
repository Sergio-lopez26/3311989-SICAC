                    ...
                    <ul className="navbar-nav me-lg-auto mb-3 mb-lg-0 w-100 w-lg-auto">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className={`dropdown-menu text-center text-lg-start z-3 ${menuActivo.citasPagos ? 'show' : ''}`}> 
                                ...
                                <li>
                                    <Link to='/Tipo_Cita' className="dropdown-item" onClick={cerrarMenus}>Tipos de Cita</Link>
                                </li>
                                <li>
                                    <Link to='/Metodo_Pago' className="dropdown-item" onClick={cerrarMenus}>Metodos de pago</Link>
                                </li>
                            </ul>
                        </li>
                    </ul>
