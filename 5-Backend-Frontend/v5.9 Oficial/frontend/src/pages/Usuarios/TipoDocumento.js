...
const GestionarTiposDocumento = () =>{
    ...
    const obtenerDatosIniciales = async () => {
        try {
            ...
            const dataTipoDoc = await res.json();
    ...
    const eliminarTDocumento = async () => {
        const { id } = datos;
        ...
        try {
            const eliminarTDoc = await fetch(`${API_URL}/${id}`, {
                method: "DELETE"
            });
            ...
            if (eliminarTDoc.ok) {
                ...
                //Para refrescar la tabla con la data actualizada en la BD tras la eliminación del Tipo de Documento
                await obtenerDatosIniciales();
            }else{
                const errorData = await eliminarTDoc.json();
                alert(`Error: ${errorData.error}`);
            }
        } catch (error) {
    ...
    return(
        ...
        <header className="text-center mt-3">
            ...
            <h6>Elige un tipo de documento para Editar</h6>
        </header>
        ...
        <div className="container-fluid mt-4"> 
            <div className="d-flex flex-nowrap justify-content-center gap-4" >
                ...
                <section id="tablaTipoDocumento" className="flex-grow-1" style={{ marginRight: "10px", minWidth: 0, maxWidth: "35vw", alignSelf: "flex-start" }}>
...
export default GestionarTiposDocumento;