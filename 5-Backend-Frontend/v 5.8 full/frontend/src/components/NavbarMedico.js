                    ...
                    <ul className="navbar-nav me-lg-auto mb-3 mb-lg-0 w-100 w-lg-auto">
                        <li className="nav-item dropdown">
                            ...
                            <ul className={`dropdown-menu text-center text-lg-start z-3 ${menuActivo.perfil ? 'show' : ''}`}> 
                                <li>
                                    <Link to='/Perfil_Medico' className="dropdown-item" onClick={cerrarMenus}>Gestionar Mi Perfil</Link>
                                </li>
                            </ul>
                        </li>

                        <li className="nav-item dropdown">
                            <a className={`nav-link dropdown-toggle ${menuActivo.mapa_dental ? 'active show' : ''}`} href="#" onClick={(e) => toggleMenu(e, 'mapa_dental')}>
                                Mapa Dental
                            </a>
                            <ul className={`dropdown-menu text-center text-lg-start z-3 ${menuActivo.mapa_dental ? 'show' : ''}`}>
                                <li><Link to='/Medico_MapaDental' className="dropdown-item" onClick={cerrarMenus}>Gestionar Mapas Dentales</Link></li>
                            </ul>
                        </li>

                        <li className="nav-item dropdown">
                            <a className={`nav-link dropdown-toggle ${menuActivo.servicio ? 'active show' : ''}`} href="#" onClick={(e) => toggleMenu(e, 'servicio')}>
                                Servicios
                            </a>
                            <ul className={`dropdown-menu text-center text-lg-start z-3 ${menuActivo.servicio ? 'show' : ''}`}>
                                 <li><Link to='/Medico_Servicios' className="dropdown-item" onClick={cerrarMenus}>Gestionar Servicios</Link></li>
                            </ul>
                        </li>
                        <li className="nav-item dropdown">
                            ...
                            <ul className={`dropdown-menu text-center text-lg-start z-3 ${menuActivo.Pacientes ? 'show' : ''}`}> 
                                <li>
                                    <Link to='/Historial_Medico' className="dropdown-item" onClick={cerrarMenus}>Gestionar historial</Link>
                                </li>
                                <li>
                                    <Link to='/Gestionar_Antecedentes' className="dropdown-item" onClick={cerrarMenus}>Gestionar Antecedentes</Link>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item dropdown">
                            <a className={`nav-link dropdown-toggle ${menuActivo.agenda ? 'active show' : ''}`} href="#" onClick={(e) => toggleMenu(e, 'agenda')}>
                                Agenda
                            </a>
                            <ul className={`dropdown-menu text-center text-lg-start z-3 ${menuActivo.agenda ? 'show' : ''}`}>
                                 <li><Link to='/Consultar_Agenda' className="dropdown-item" onClick={cerrarMenus}>Consultar Agenda</Link></li>
                            </ul>
                        </li>
                        {/* Seguir estructura
                        <li className="nav-item dropdown">
