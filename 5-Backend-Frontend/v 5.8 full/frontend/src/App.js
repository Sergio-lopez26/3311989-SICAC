...
import GestionarCitas from "./pages/Administrador/GestionarCitas"
import MetodoPago from "./pages/Administrador/MetodoPago"
import TipoCita from "./pages/Administrador/TipoCita"
//
...
import AgendaMedico from "./pages/Medicos/AgendaMedico";
import GestionarAntecendentes from "./pages/Medicos/GestionarAntecedentes";
        ...
        <Router>
                <Routes>
                    ...
                    <Route element={<RutaProteccionMed />}>
                        ...
                        <Route path="/Consultar_Agenda" element={<AgendaMedico />} />
