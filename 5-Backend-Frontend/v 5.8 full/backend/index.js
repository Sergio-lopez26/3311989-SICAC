...
app.use('/api/diagnostico', diagnosticoRoute); //->/cita/:id_cita
app.use('/api/diagnostico_medicamento', diagnosticoMedicamentoRoute); //->/diagnostico/:id_diagnostico
app.use('/api/historial_medico', historialMedicoRoute); //->/paciente/:id
